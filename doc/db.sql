...
CREATE TABLE `sys_menu` (
  ...
  `parent_id` varchar(100) COMMENT '父菜单ID，一级菜单为0',
...
CREATE TABLE `schedule_job` (
  ...
  `status` varchar(4) DEFAULT NULL COMMENT '任务状态',
...
CREATE TABLE `schedule_job_log` (
  `log_id` varchar(100) NOT NULL  COMMENT '任务日志id',
  `job_id` varchar(100) NOT NULL COMMENT '任务id',
  `bean_name` varchar(200) DEFAULT NULL COMMENT 'spring bean名称',
  `method_name` varchar(100) DEFAULT NULL COMMENT '方法名',
  `params` varchar(2000) DEFAULT NULL COMMENT '参数',
...
INSERT INTO `schedule_job` VALUES ('1','1','testTask', 'test2', NULL, '0 0/30 * * * ?', '1', '无参数测试', '2016-12-03 14:55:56');
