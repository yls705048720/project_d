...
import com.yls.freamwork.utils.YlsDateUtils;
...
public interface GenUtils {
	...
	public static void generatorCode(Map<String, String> table, 
		...
		map.put("datetime", YlsDateUtils.format(new Date(), YlsConstants.DATE_TIME_PATTERN));
		...
		for(String template : templates){
			...
			try {
				...
				throw new YlsRRException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new YlsRRException("获取配置文件失败，", e);
		}
	}
