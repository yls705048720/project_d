...
public interface YlsScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new YlsRRException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new YlsRRException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new YlsRRException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new YlsRRException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new YlsRRException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, String jobId) {
        try {
            ...
            throw new YlsRRException("删除定时任务失败", e);
        }
    }
}
