...
var vm = new Vue({
	...
	methods: {
		...
		update: function () {
			...
			$.get(path+"sysSchedule/info/"+jobId, function(r){
				vm.showList = false;
                vm.title = "修改";
		...
		saveOrUpdate: function (event) {
			var url = vm.schedule.jobId == null ?  path+"sysSchedule/save" : path+"sysSchedule/update";
			$.ajax({
				type: "POST",
			    url: url,
